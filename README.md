...
Jogo com o tema " invasão pirata ", utilizando motores de física.
...
## ⚙️ Funcionalidades
- Mova o ângulo do canhão com Setas esquerda e direita
- Atire com a Seta para baixo
- Cada barco destruído ( +5 pontos )
- Se um dos barcos chegarem à torre ( Derrota )
